...
function projects_search_page() {
	...
	// groups plugin saves tags as "interests" - see projects_fields_setup() in start.php
	$params = array(
...
function projects_handle_profile_page($guid) {
	...
	projects_register_profile_buttons($group);
 ...
 */
function projects_register_profile_buttons($group) {
 ...
 * @return array
 */
function projects_prepare_form_vars($group = null) {
	$values = array(
		'name' => '',
