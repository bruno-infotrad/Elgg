...
$body .= "<div>";
$body .= elgg_echo("group_tools:settings:invite_skills");
$body .= elgg_view("input/dropdown", array("name" => "params[invite_skills]", "options_values" => $noyes_options, "value" => $plugin->invite_skills, "class" => "mls"));
$body .= "</div>";
