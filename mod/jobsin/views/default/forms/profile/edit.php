	...
	if(!empty($cats)){
		...
		foreach($cats as $cat_guid => $cat){
			...
			foreach($fields[$cat_guid] as $field){
				...
				// get type of field
				if($field->user_editable == "no" && ! elgg_is_admin_logged_in()){
				...
				if ($metadata_name == 'project_manager') {
					$field_result .= $metadata_name.elgg_view('input/access', array('name' => 'accesslevel[' . $metadata_name . ']', 'options_values' => array(ACCESS_PUBLIC => elgg_echo("PUBLIC"))));
				} else {
