...
echo "<div class=\"label\">" . elgg_echo('jobsin:info:sidebar') . "</div>";
echo "<div>" . elgg_echo('jobsin:info:modules') . "</div>";

echo '<div class="item">';
echo elgg_echo('jobsin:label:show_icon');
echo ' ';
echo elgg_view('input/dropdown', array(
	'name' => 'params[show_icon]',
	'options_values' => array(
		'no' => elgg_echo('option:no'),
		'sidebar_alt' => elgg_echo('jobsin:option:sidebar:left'),
		'sidebar' => elgg_echo('jobsin:option:sidebar:right')
	),
...
echo '<div class="item">';
echo elgg_echo('jobsin:label:menu');
echo ' ';
echo elgg_view('input/dropdown', array(
...
echo '<div class="item">';
echo elgg_echo('jobsin:label:custom');
echo ' ';
echo elgg_view('input/dropdown', array(
...
echo '<div>';
echo elgg_echo('jobsin:label:html');
echo ' ';
