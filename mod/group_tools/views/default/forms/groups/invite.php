<?php
	...
	$invite_competences = elgg_extract("competences", $vars, "yes");
	...
	if(in_array("yes", array($invite_site_members, $invite_competences,$invite_email, $invite_csv))){
		$tabs = array(
			"friends" => array(
		...
		//invite by competence
		if($invite_competences == "yes"){
			$tabs["competences"] = array(
				"text" => elgg_echo("group_tools:group:invite:competences"),
				"href" => "#",
				"rel" => "competences",
				"priority" => 350,
				"onclick" => "group_tools_group_invite_switch_tab(\"competences\");"
			);
			
			$form_data .= "<div id='group_tools_group_invite_competences'>";
			$form_data .= "<div>" . elgg_echo("group_tools:group:invite:competences:description") . "</div>";
			$form_data .= elgg_view("input/group_invite_autocomplete", array("name" => "user_guid",
						"id" => "group_tools_group_invite_autocomplete_competences",
						"group_guid" => $group->getGUID(),
	...
	function group_tools_group_invite_switch_tab(tab){
		...
		switch(tab){
			...
			case "competences":
				...
				$('#group_tools_group_invite_competences').show();
				break;
			case "email":
				$('#group_tools_group_invite_friends').hide();
				$('#group_tools_group_invite_competences').hide();
